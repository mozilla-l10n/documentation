...
Pontoon doesn’t allow to see all translations for a specific string, but you can use Pontoon's [Translation Search](https://pontoon.mozilla.org/search/) for it:
