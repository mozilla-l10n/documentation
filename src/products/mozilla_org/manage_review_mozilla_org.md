...
The Mozilla.org project consists of many files, so [Pontoon Tags](https://pontoon.mozilla.org/docs/admin/adding-new-project/) can be used to help localizers prioritize specific content. Given the lack of clarity from the marketing team, this is rarely used nowadays.
