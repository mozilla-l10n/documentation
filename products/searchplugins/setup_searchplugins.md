...
Assuming you followed the instructions to [setup the environment](/tools/mercurial/setting_mercurial_environment.md), you’re ready to create the patch. Once again, Firefox desktop will be used as an example, but the procedure is the same for Firefox for Android.
