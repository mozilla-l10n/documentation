...
First of all make sure that your environment is [correctly set up](setting_environment.md), and update your local mozilla-unified clone to be in sync with central:
```
